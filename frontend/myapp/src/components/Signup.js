    ...
    return (
        <div className='signUp'>
            ...
            <div className="formContainer">
                <h2>V-Notes</h2>
                <h4>SignUp to use V-Notes to customise your task.</h4>
                <form className="form" onSubmit={formSubmit}>
                    <input type="text" name="name" id="name" placeholder='Enter Your Name' onChange={change} value={credentials.name} />
                    <input type="email" name="email" id="email" placeholder='Enter Your Email' onChange={change} value={credentials.email} />
